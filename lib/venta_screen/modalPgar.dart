...
class _PagoModalState extends State<PagoModal> {
  ...
  final ObtenerClientesController clientesController = Get.put(ObtenerClientesController());
                    ...
                    Row(
                      children: [
                        ...
                        IconButton(
                          ...
                          icon: const Icon(Icons.person_add, color: Colors.amber, size: 30),
                      ...
                      child: Obx(() {
                        ...
                        return ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final seleccionado = usuarioSeleccionado?.idCliente == usuario.idCliente;
                            return InkWell(
                              borderRadius: BorderRadius.circular(16),
                              onTap: () {
                                setState(() {
                                  usuarioSeleccionado = seleccionado ? null : usuario;
                                });
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(16),
                                  color: seleccionado ? Colors.amber[200] : Colors.white,
                                  border: Border.all(
                                    color: seleccionado ? Colors.amber : Colors.transparent,
                                    width: 2,
                                  ),
                                  boxShadow: [
                                    BoxShadow(
                                ...
                                child: Row(
                                  children: [
                                    Icon(
                                      ...
                                      color: seleccionado ? Colors.amber[800] : Colors.grey,
                                    ),
                          ...
                          usuarioSeleccionado == null
                              ...
                              : Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        const Icon(Icons.phone_android, size: 26, color: Colors.amber),
                                        const SizedBox(width: 12),
                                        Text(
                                  ...
                                  children: [
                                    Card(
                                      ...
                                      child: ListTile(
                                        ...
                                        title: const Text(
                                          "Café gratis en tu próxima compra",
                                          style: TextStyle(fontWeight: FontWeight.w600),
                                        ),
                                        subtitle: const Text("Válido hasta el 31/05/2025"),
                                      ),
                                    ),
                                    Card(
                                      ...
                                      child: ListTile(
                                        ...
                                        subtitle: const Text("Válido para pedidos superiores a \$100"),
                                      ),
                                    ),
                                    // Puedes agregar más promociones aquí para probar el scroll
                                  ],
                                ),
                              ),
                            ),
